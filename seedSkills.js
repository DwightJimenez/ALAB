...
const seedData = async () => {
  try {
    ...
    // 1. Create the Skill
    const spillSkill = await Skill.create({
      name: "Chemical Spill Response",
      description:
        "Proper procedures for containing and cleaning hazardous chemical spills.",
      pL0: 0.1,
      pT: 0.25,
      pG: 0.2,
      pS: 0.1,
    ...
    // 2. Create REAL Questions for that Skill
    ...
    console.log("Real Quiz Questions seeded successfully!");
    process.exit();
  } catch (error) {
