      ...
      <div className='flex items-center justify-center min-h-screen bg-[url(/login.webp)] bg-cover bg-right sm:bg-center'>
        <div className='min-h-screen py-6 flex flex-col justify-center sm:py-12 flex-1'>
          <div className='relative py-3 sm:max-w-xl sm:mx-auto'>
            ...
            {/* THE GLASS CARD */}
            <div className='sm:relative bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl sm:rounded-3xl p-20'>
              <div className='flex min-h-full flex-col justify-center px-6  lg:px-8'>
                ...
                <div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm'>
                  ...
                  >
                    <div>
                      ...
                      <div className='mt-2'>
                        <input
                          ...
                          required
                          autoComplete='email'
                          className='block w-full rounded-md bg-white/5 border border-cold px-3 py-1.5 text-base text-black placeholder:text-gray-300 outline-none focus:bg-white/10 focus:border-navy sm:text-sm/6 transition-all'
                          value={email}
                    ...
                    {errorMessage && (
                      <div className='mt-4 text-center text-sm font-semibold text-red-400 bg-red-500/20 backdrop-blur-md border border-red-500/30 p-2 rounded'>
                        {errorMessage}
                      </div>
                    )}
